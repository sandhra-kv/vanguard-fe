...
const CampaignSetup = ({openSection, setOpenSection}) => {
   ...
   return (
      <div className="campaign-setup">
         ...
         >
            <div className="w-full bg-white py-7 border border-[#E4E7EC] rounded-b-xl p-4">
               <OptionSelector
                  ...
                  options={["Lead Nurturing", "Cold Outreach", "Product Release", "Follow-Up"]}
                  selectedOption={obj}
               />
            </div>
         </CollapsibleMenu>
         ...
         <CollapsibleMenu
            ...
            renderLabel={() => (
               <button
                  ...
                  className={`flex w-full text-start items-center justify-between py-4 font-medium h-16 bg-white border-[#E4E7EC] p-4 mt-7 ${
                     openSection === "sequence" ? "rounded-t-xl border-t border-l border-r" : "rounded-xl border"
                  }`}
               >
                  ...
                  <img
                     src="/icons/down.svg"
                     alt="arrow"
                     className={`size-3 ${openSection === "sequence" ? "rotate-180" : ""}`}
                  />
               </button>
            )}
         >
         ...
         <CollapsibleMenu
            isFilterOpen={openSection === "setup_triggers"}
            renderLabel={() => (
               <button
                  onClick={() => toggleSection("setup_triggers")}
                  className={`flex w-full text-start items-center justify-between py-4 font-medium h-16 bg-white border-[#E4E7EC] p-4 mt-7 ${
                     openSection === "setup_triggers" ? "rounded-t-xl border-t border-l border-r" : "rounded-xl border"
                  }`}
               >
                  Setup Trigger-Based Plays
                  <img
                     src="/icons/down.svg"
                     alt="arrow"
                     className={`size-3 ${openSection === "setup_triggers" ? "rotate-180" : ""}`}
                  />
               </button>
            )}
         >
         ...
         <CollapsibleMenu
            isFilterOpen={openSection === "review"}
            renderLabel={() => (
               <button
                  onClick={() => toggleSection("review")}
                  className={`flex w-full text-start items-center justify-between py-4 font-medium h-16 bg-white border-[#E4E7EC] p-4 mt-7 ${
                     openSection === "review" ? "rounded-t-xl border-t border-l border-r" : "rounded-xl border"
                  }`}
               >
                  Review
                  <img
                     src="/icons/down.svg"
                     alt="arrow"
                     className={`size-3 ${openSection === "review" ? "rotate-180" : ""}`}
                  />
               </button>
            )}
         >
