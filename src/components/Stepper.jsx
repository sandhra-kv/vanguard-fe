...
const Stepper = ({ steps, openModal, extractYouTubeIds }) => {
               ...
               <div key={index} className="flex items-start space-x-4 relative">
                  ...
                  <div className="flex-1">
                     <div className="flex items-center space-x-2">
                        {/* Username */}
                        <span className="font-medium text-base text-[#101928]">{step?.senderName}</span>

                        {/* Timestamp */}
                        <span className="text-base text-[#8DA0B1]">{getTime(step?.createdAt)}</span>
                     </div>
